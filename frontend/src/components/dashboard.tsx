  ...
  return (
    <div className="flex flex-col gap-8">
        ...
        <div className="relative z-10 p-8 md:p-12">
          ...
          >
            <div className="flex items-center gap-2 mb-4">
              ...
              <span
                className="text-xs font-semibold tracking-widest uppercase px-2.5 py-1 rounded-full"
                style={{ background: "rgba(167,139,250,0.08)", color: "var(--ai-violet)", border: "1px solid rgba(167,139,250,0.2)" }}
              >
                SDG 12 · 13
              </span>
            </div>
            ...
            <h1
              ...
              style={{
                background: "linear-gradient(135deg, #f0f4f1 0%, #34d399 45%, #22d3ee 100%)",
            ...
            >
              ...
              <span style={{
                ...
                backgroundClip: "text",
                fontSize: "0.65em",
              }}>AI Resource Intelligence</span>
            </h1>

            <p className="text-base mb-6 max-w-xl" style={{ color: "var(--text-secondary)" }}>
              Stop discarding. Start circulating. Circular Tech gives every institutional asset a second life through
              AI-driven analysis, intelligent matching, and transparent decision-making.
            </p>
      ...
      <SectionReveal delay={0.1}>
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          {[
            ...
            { label: "Under Review",      value: review,    sublabel: "Awaiting AI decision",  accent: false },
          ].map((m, i) => (
            <motion.div
              key={m.label}
              className="glass p-5"
      ...
      <SectionReveal delay={0.15}>
        <div className="mb-2">
          <p className="text-xs font-semibold tracking-widest uppercase mb-1" style={{ color: "var(--text-muted)" }}>Why Circular Tech</p>
          <h3 className="text-lg font-semibold" style={{ color: "var(--text-primary)" }}>Built for the Circular Economy</h3>
        </div>
          ...
          {[
            {
              ...
              title: "AI Lifecycle Decisions",
              description: "7 evidence-based actions — Repair, Refurbish, Reuse, Redeploy, Recycle, Replace, Review. Confidence scores, not guesses.",
              tag: "OpenRouter AI",
            },
            {
              ...
              title: "Zero-Waste Circular Loop",
              description: "Surplus assets from one department matched to requests from another. Avoid new procurement before it happens.",
              tag: "Auto Matching",
            },
            {
              ...
              description: "Track ₹ procurement avoided, kg e-waste saved, lifecycle months extended. Every decision leaves an evidence trail.",
              tag: "SDG 12 · 13",
            },
            {
              ...
              description: "Human-in-the-loop for every irreversible decision. Full audit log, transparent assumptions, zero silent failures.",
              tag: "Human Oversight",
            },
          ].map((usp, i) => (
            <motion.div
              key={usp.title}
              className="glass p-5 flex flex-col gap-3 border-glow-emerald"
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ delay: i * 0.08 + 0.1, duration: 0.4 }}
              whileHover={{ y: -3, boxShadow: `0 8px 32px ${usp.glow}` }}
            >
              <div
                className="w-10 h-10 rounded-xl flex items-center justify-center"
                style={{ background: usp.glow, color: usp.color, border: `1px solid ${usp.color}30` }}
              >
                {usp.icon}
              </div>
              <div>
                <p className="text-sm font-semibold mb-1" style={{ color: "var(--text-primary)" }}>{usp.title}</p>
                <p className="text-xs leading-relaxed" style={{ color: "var(--text-muted)" }}>{usp.description}</p>
              </div>
              <span
                className="text-xs font-medium px-2 py-0.5 rounded-full w-fit mt-auto"
                style={{ background: `${usp.color}15`, color: usp.color, border: `1px solid ${usp.color}30` }}
              >
                {usp.tag}
              </span>
            </motion.div>
