    ...
    <>
      ...
      >
        ...
        <div className="flex items-center gap-3 px-4 h-16 shrink-0" style={{ borderBottom: "1px solid var(--border)" }}>
          ...
          >
            <Recycle size={15} strokeWidth={2.5} />
          </div>
          <AnimatePresence>
            {!collapsed && (
              <motion.div
          ...
          {!collapsed && (
            <div className="flex flex-col gap-1.5 mt-1">
              ...
              >
                ...
                <div>
                  <p className="text-xs font-semibold" style={{ color: "var(--emerald)" }}>SDG 12 · SDG 13</p>
                  <p className="text-xs" style={{ color: "var(--text-muted)" }}>Responsible consumption &amp; Climate action</p>
                </div>
              </div>
              <div className="flex items-center justify-between px-1">
                <span className="text-xs" style={{ color: "var(--text-muted)" }}>Circular Tech v1.0</span>
            ...
            >
              ...
              <div className="flex items-center gap-3 px-4 h-16 shrink-0" style={{ borderBottom: "1px solid var(--border)" }}>
                ...
                <div className="flex flex-col">
                  <span className="text-sm font-bold" style={{ color: "var(--text-primary)" }}>Circular</span>
                  <span
